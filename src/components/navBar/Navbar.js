        ...
        <div className="container">
          <nav ref={navRef} className='nav_bar'>
            ...
            <ul className="nav_list">
              <li><Link to="/" className="nav_link">Главная</Link></li>
              <li><Link to="/federation" className="nav_link">НАША ФЕДЕРАЦИЯ</Link></li>
              <li><Link to="/gallery" className="nav_link">ГАЛЕРЕЯ</Link></li>
              <li><Link to="/competition" className="nav_link">СОРЕВНОВАНИЯ</Link></li>
              {/* <li>
